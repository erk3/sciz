...
class Troll(Being):
    ...
    viewed_troll_privates_capas = relationship('TrollPrivateCapa', back_populates='viewer', primaryjoin='Troll.id == TrollPrivateCapa.viewer_id', viewonly=True)
    viewed_mob_privates = relationship('MobPrivate', back_populates='viewer', primaryjoin='Troll.id == MobPrivate.viewer_id')
    owned_mob_privates = relationship('MobPrivate', back_populates='owner', primaryjoin='and_(Troll.id == MobPrivate.viewer_id, Troll.id == MobPrivate.owner_id)', viewonly=True)
    viewed_tresor_privates = relationship('TresorPrivate', back_populates='viewer', primaryjoin='Troll.id == TresorPrivate.viewer_id')
    owned_tresor_privates = relationship('TresorPrivate', back_populates='owner', primaryjoin='and_(Troll.id == TresorPrivate.viewer_id, Troll.id == TresorPrivate.owner_id)', viewonly=True)
    viewed_champi_privates = relationship('ChampiPrivate', back_populates='viewer', primaryjoin='Troll.id == ChampiPrivate.viewer_id')
    owned_champi_privates = relationship('ChampiPrivate', back_populates='owner', primaryjoin='and_(Troll.id == ChampiPrivate.viewer_id, Troll.id == ChampiPrivate.owner_id)', viewonly=True)

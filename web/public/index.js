var app = angular.module('app', ['ui.router', 'ui.bootstrap', 'ngCookies', /* 'ngSanitize', */ 'infinite-scroll', 'ngclipboard', 'ngAria', '720kb.tooltips', 'textAngular', 'ui.carousel', 'ngMaterial']);
